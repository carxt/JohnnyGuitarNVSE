...
public:
	...
	virtual bool							GetActorGuard() const;
	virtual void							SetActorGuard(bool abVal);
	...
	virtual void							UseActionPointsAlt(uint32_t aeAction);
	...
	virtual void							TempModActorValueF(ActorValue::Index aeIndex, float afModifier, Actor* apAttacker);
	virtual void							TempModActorValueI(ActorValue::Index aeIndex, int32_t aiModifier, Actor* apAttacker);
	virtual void							PermanentModActorValueF(ActorValue::Index aeIndex, float afModifier, Actor* apAttacker);
	virtual void							PermanentModActorValueI(ActorValue::Index aeIndex, int32_t aiModifier, Actor* apAttacker);
	virtual void							DamageModActorValueF(ActorValue::Index aeIndex, float afModifier, Actor* apAttacker);
	virtual void							DamageModActorValueI(ActorValue::Index aeIndex, int32_t aiModifier, Actor* apAttacker);
	virtual void							ModActorBaseValueF(ActorValue::Index aeIndex, float afModifier);
	virtual void							ModActorBaseValueI(ActorValue::Index aeIndex, int32_t aiModifier);
	virtual ItemChange*						GetBestWeapon(COMBAT_WEAPON_TYPE aeWeaponType) const;
	...
	virtual bool							ReloadWeapon(TESObjectWEAP* apWeapon, int32_t aiReloadAnim, bool abUseModValue);
	virtual bool							ReloadWeaponNV(TESObjectWEAP* apWeapon, int32_t aiReloadAnim, bool abUseModValue, bool abFromInventory);
	...
	virtual void							GetPowerAttackPercent(uint32_t aeType);
	...
	virtual void							UseSkill0(ActorValue::Index aeSkill, uint32_t aeAction);
...
class Actor : public TESObjectREFR, public ActorValueOwner {
public:
	TESActorBase* GetActorBase() const;
};
ASSERT_SIZE(Actor, 0x88u);
#endif