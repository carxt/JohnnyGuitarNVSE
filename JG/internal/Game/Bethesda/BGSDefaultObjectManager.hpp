...
public:
	...
	using DefaultObject = _DefaultObject::Object;
	...
	union {
		...
		TESForm* pForms[DefaultObject::COUNT];
	};
	...
	static TESForm* GetDefaultObject(DefaultObject aeObject);
};

#ifdef GAME
ASSERT_SIZE(BGSDefaultObjectManager, 0xA0);
#else
ASSERT_SIZE(BGSDefaultObjectManager, 0xB4);
#endif