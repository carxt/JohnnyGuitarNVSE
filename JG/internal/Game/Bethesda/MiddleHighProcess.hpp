...
public:
	...
	virtual void	ProcessRemoveWornAlt(Actor* apActor, bool abIterateIndex, bool abClothesOnly);
	...
	BSSimpleList<DeferredHideLimb*>		kDeferredLimbHideList;
