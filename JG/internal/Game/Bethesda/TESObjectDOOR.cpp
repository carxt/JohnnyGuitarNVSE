...
#else
	if (apSpace && CanBeRandomTeleport(apSpace))
		return kRandomTeleports.IsInList(const_cast<TESForm*>(apSpace));
	return false;
#endif
}
...
#else
	return CdeclCall<bool>(0x5F9880, apSpace);
#endif
}
