...
#else
	return ThisCall<uint32_t>(0x56ACE0, this);
#endif
}
...
#else
	return ThisCall<TESIdleForm*>(0x56A8A0, this, auiIndex);
#endif
}
...
#else
	return ThisCall<uint32_t>(0x56A8D0, this, apChild);
#endif
}
...
#else
	if (apChild && pChildren )
		RemoveChildAtIndex(GetIndexForChild(apChild));
#endif
}
...
#else
	ThisCall(0x56B320, this, auiIndex);
#endif
}
