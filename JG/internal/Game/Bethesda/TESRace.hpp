...
public:
	...
	void AddEyeColor(TESEyes* apEyes);

	const TESModel* GetHeadPartModel(SEX aeSex, HeadPart aePart) const;
	void SetHeadPartModel(SEX aeSex, HeadPart aePart, const char* apPath);
	
	const TESTexture* GetHeadPartTexture(SEX aeSex, HeadPart aePart) const;
	void SetHeadPartTexture(SEX aeSex, HeadPart aePart, const char* apPath);

	const TESTexture* GetBodyPartTexture(SEX aeSex, BodyPart aePart) const;
	void SetBodyPartTexture(SEX aeSex, BodyPart aePart, const char* apPath);

	const TESModel* GetBodyPartModel(SEX aeSex, BodyPart aePart) const;
	void SetBodyPartModel(SEX aeSex, BodyPart aePart, const char* apPath);

	const BGSTextureModel* GetBodyTextureModel(SEX aeSex) const;
