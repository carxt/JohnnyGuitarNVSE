...
struct FileFinder {
	...
	static bool Locate(const char* apName, const char* apFilePath, uint32_t aiFlags, ARCHIVE_TYPE aiArchiveType);
	bool Exist(const char* apName, const char* apFilePath, uint32_t aiFlags, ARCHIVE_TYPE aiArchiveType);
};