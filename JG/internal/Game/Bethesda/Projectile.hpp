...
public:
	...
	struct ImpactData {
		...
		HK_MATERIAL_TYPE	eMaterial;
		LIMB_TYPE			eDamageLimb;
		bool				bProcessed;
		bool				bDoDamage;
	...
	struct ALIGN4 _ProjectileFlags {
		...
		bool bHitscan					: 1;
		bool bNo3D						: 1;
		bool bNoCharController			: 1;
		bool bNoCollision				: 1;
		bool bTracer					: 1;
		bool bFading					: 1;
		bool bReorient					: 1;
		bool bPostProcess				: 1;
		bool bCheckBehindWall			: 1;
		bool bTurnedOff					: 1;
		bool bActiveInInventory			: 1;
		bool bInventoryFreakout			: 1;
		bool bAlwaysHitTarget			: 1;
		bool bSpawnExplosionAtImpact	: 1;
		bool bNoPlayerProximity			: 1;
		bool bKillAnExplosion			: 1;
		bool bInitialized				: 1;
		bool bFakeShot					: 1;
		bool bWholeBodyTargeted			: 1;
		bool bShooterInCombat			: 1;
		bool bDetonate					: 1;
	};
...
public:
	...
	NiPointer<NiAVObject>	spPart;
	NiPoint3				kOffset;
};

ASSERT_SIZE(ProjectileTarget, 0x14);