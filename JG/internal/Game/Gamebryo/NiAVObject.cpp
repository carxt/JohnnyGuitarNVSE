...
// GAME - 0xA59D30
// GECK - 0x80DE30
NiProperty* NiAVObject::GetProperty(NiProperty::Type aePropertyType) const {
#ifdef GAME
...
// GAME - 0xA5B230
// GECK - 0x80F2B0
void NiAVObject::RemoveProperty(NiProperty::Type aePropertyType) {
#ifdef GAME
...
// GAME - 0xA5AAC0
// GECK - 0x80EB40
void NiAVObject::RemoveProperty(NiProperty::Type aePropertyType, NiPointer<NiProperty>& arRemovedProperty) {
#ifdef GAME
...
bool NiAVObject::GetFlag(uint32_t auiFlags) const {
	return m_uiFlags.IsSet(auiFlags);
}

void NiAVObject::SetFlag(uint32_t auiFlags, bool abVal) {
	m_uiFlags.Set(auiFlags, abVal);
}
...
// GAME - 0x938160
void NiAVObject::SetIsPlayerBone(bool abVal) {
