...
public:
	...
	NiProperty* GetProperty(NiProperty::Type aePropertyType) const;

	void AttachProperty(NiProperty* apProperty);
	void DetachProperty(NiProperty* apProperty);

	void RemoveProperty(NiProperty::Type aePropertyType);
	void RemoveProperty(NiProperty::Type aePropertyType, NiPointer<NiProperty>& arRemovedProperty);
	...
	bool GetFlag(uint32_t auiFlags) const;
	void SetFlag(uint32_t auiFlags, bool abVal);
	...
	void SetIsPlayerBone(bool abVal);
